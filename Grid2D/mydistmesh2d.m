function [p,t]=mydistmesh2d(fd,fh,h0,bbox,pfix,niters,varargin)
% This was taken from distmesh and modified.
% Find the original here: http://persson.berkeley.edu/distmesh/
